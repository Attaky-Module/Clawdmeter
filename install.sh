...
echo "and connect to the Attaky Core over Bluetooth Low Energy."
echo ""
echo "First-time Bluetooth pairing:"
echo "  1. Power on the Attaky Core"
echo "  2. Run: bluetoothctl scan le"
echo "  3. Find 'Attaky Claude Monitor' and note the MAC address"
